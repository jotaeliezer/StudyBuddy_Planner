...
const COLORS = [
  '#FFD1DC', '#C1E1C1', '#AEC6CF', '#C3B1E1', '#FDFD96', 
  '#FFDAC1', '#FFB7B2', '#E2F0CB', '#B5EAD7', '#FF9AA2'
];
...
function CourseModal({ isOpen, onClose, onSave, existingCourse }: CourseModalProps) {
...
export function WeeklyView({ tasks, courses, categories, onAddTask, onToggleTaskCompletion, onEditTask, onAddCourse, onUpdateCourse, onDeleteCourse, onReorderCourses, todaysMoodEmoji }: WeeklyViewProps) {
  ...
  if (hasOtherTasks) {
    courseRows.push({ id: 'other', name: 'Other Tasks', color: '#9ca3af', description: '' });
  }
